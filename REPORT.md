...
# Документация класса RiscVSimulator
...
Разбирает и выполняет отдельную инструкцию RISC-V.

Параметры:
- `instruction`: Строка с инструкцией RISC-V.

## Поддерживаемые инструкции

# Поддерживаемые инструкции RISC-V
